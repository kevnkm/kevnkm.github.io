...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    ...
    const playClose = useCallback((): void => {
        openTlRef.current?.kill();
    ...
    return (
        <>
            <div
                className={`fixed inset-0 w-full h-screen z-[35] transition-all duration-500 ease-in-out ${open ? "backdrop-blur-md opacity-100" : "backdrop-blur-none opacity-0 pointer-events-none"}`}
                aria-hidden="true"
            ></div>
            <div
                ref={wrapperRef}
